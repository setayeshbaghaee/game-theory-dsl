...
static const char* GAME_NAME = "PrisonersDilemma";
static const char* PLAYERS[N_PLAYERS] = {
    "A",
    "B"
};

static const char* STRATS_P0[2] = { "Cooperate", "Defect" };
static const char* STRATS_P1[2] = { "Cooperate", "Defect" };

static const char** STRATS[N_PLAYERS] = { STRATS_P0, STRATS_P1 };
static const int STRAT_COUNTS[N_PLAYERS] = { 2, 2 };
...
static const char* COMPUTE = "Nash";
